    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='images/chat/avatar/')),
                ('type', models.CharField(choices=[('PR', 'Private'), ('PB', 'Public'), ('OO', 'OneToOne')], default='PR', max_length=2)),
                ...
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='chat', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.FileField(blank=True, null=True, upload_to='files/chat/')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('time', models.TimeField(auto_now_add=True)),
